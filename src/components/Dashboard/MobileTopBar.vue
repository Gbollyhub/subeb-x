<template>
    ...
    <div class="app-nav mobile"><img style="margin-top:10px" height="50" src="https://res.cloudinary.com/dja6wv2sl/image/upload/v1651529994/Frame_2_1_emtqgp.svg" loading="lazy" alt=""><img @click="isMobileMenu = true" src="../../assets/images/ant-design_menu-outlined-1.svg" loading="lazy" width="32" alt=""></div>
    </div>
</template>
